...
seg5p00array = m.seg5p00array(1,2:end);
seg5p01array = m.seg5p01array(1,2:end);
seg5p10array = m.seg5p10array(1,2:end);
seg5rmsearray = m.seg5rmsearray(1,2:end);
...
save('finaldata', 'seg2p00array', 'seg2p01array', 'seg2p10array', 'seg2rmsearray', 'seg3p00array', 'seg3p01array', 'seg3p10array', 'seg3rmsearray', 'seg4p00array', 'seg4p01array', 'seg4p10array', 'seg4rmsearray', 'seg5p00array', 'seg5p01array', 'seg5p10array', 'seg5rmsearray', '-append');
